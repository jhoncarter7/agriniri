...
const USPItem = ({ title, content, icon, direction = "left" }) => {
  ...
  return (
    <motion.div
      ...
      className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow font-family-gilroy"
    >
            ...
            content={[
              <div key="ai-content" className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm">Advanced pesticide reduction processes</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-sm">Delivering safer, higher-quality produce</p>
                </div>
              </div>
            ]}
          />
